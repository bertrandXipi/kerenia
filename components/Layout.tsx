              ...
              <div className="flex flex-col items-center justify-center flex-grow space-y-8 p-6">
                {NAV_ITEMS.map((item, index) => (
                  ...
                  >
                    <Link
                      href={item.path}
                      className={`font-condensed font-bold uppercase text-3xl tracking-widest transition-colors ${pathname === item.path ? 'text-brick-400' : 'text-white hover:text-brick-300'
                        }`}
