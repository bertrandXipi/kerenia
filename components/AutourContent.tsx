    ...
    <div className="pb-20 pt-24 bg-cream-50">
      <div className="bg-cream-100 py-16 mb-16 border-b border-gold-200">
        <div className="container mx-auto px-6 text-center">
          <h3 className="font-condensed text-gold-700 uppercase tracking-widest text-sm font-bold mb-2">Le Pays Basque</h3>
          <h1 className="font-serif text-5xl md:text-6xl text-brick-800 mb-6 font-light">S&apos;offre à vous</h1>
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 gap-16">
          {ACTIVITIES.map((activity, index) => (
            ...
            >
              ...
              <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-cream-50 border border-gold-200 border-l-0">
                <h2 className="font-serif font-medium text-3xl text-brick-800 mb-4">{activity.title}</h2>
                ...
                {activity.link && activity.link !== '#' && (
                  <a 
                    ...
                    className="inline-flex items-center text-gold-700 font-bold hover:text-gold-800 transition-colors font-condensed uppercase tracking-wider text-sm border-b border-gold-600 pb-1 self-start"
                  >
        ...
        <div className="mt-20 bg-brick-800 rounded-sm p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl border-t-4 border-gold-500">
          <div className="relative z-10">
            <MapPin className="w-12 h-12 mx-auto text-gold-400 mb-6" />
            <h2 className="font-serif font-medium text-3xl md:text-4xl mb-6">Un emplacement idéal</h2>
