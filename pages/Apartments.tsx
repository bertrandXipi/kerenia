...
import { APARTMENTS, AMENITIES } from '../constants';
    ...
    <div className="pb-20">
      ...
      <div className="bg-stone-50 py-16 mb-16 border-b border-stone-200">
        <div className="container mx-auto px-6 text-center">
            ...
            16 appartements de 25m2 à 45m2 avec terrasses, entièrement rénovés. Une décoration soignée dans une atmosphère chaleureuse.
            </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 mt-24">
        <div className="bg-stone-100 p-8 text-center border-l-4 border-brick-600">
          ...
          <p className="text-slate-600 font-light">
            ...
            N'hésitez pas à nous contacter pour vérifier leur disponibilité.
          </p>
        </div>
      </div>
    </div>
